...
const userprofile = ({userProfile, logoutProfile}) => {
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center"> 
      ...
      <div className="flex lg:flex-row md:flex-col ">
        ...
        <img className='w-6' src='https://img.icons8.com/external-febrian-hidayat-outline-color-febrian-hidayat/344/external-logout-user-interface-febrian-hidayat-outline-color-febrian-hidayat.png' ></img>
          <span className="ml-4 flex items-start flex-col leading-none">
