...
const Contact = () => {
  ...
  return (
    ...
    <div className="absolute inset-0 bg-gray-300">
      <iframe width="100%" height="100%" frameBorder="0" marginHeight="0" marginWidth="0" title="map" scrolling="no" src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=(Arizona State University, Tempe, AZ)&ie=UTF8&t=&z=14&iwloc=B&output=embed" style={{filter: "grayscale(1) contrast(1.2) opacity(0.4)"}}></iframe>
    </div>
    <div className="container px-5 py-24 mx-auto flex">
      <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
        <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Feedback</h2>
        <p className="leading-relaxed mb-5 text-gray-600">Please share your thoughts and message to get the source code.</p>
        <form  ref={formRef} onSubmit={handleSubmit}>
        <div className="relative mb-4">
          <label htmlFor="email" className="form-group leading-7 text-sm text-gray-600">Name</label>
        ...
        <div className="relative mb-4">
          <label htmlFor="email" className="form-group leading-7 text-sm text-gray-600">Email</label>
        ...
        <div className="relative mb-4">
          <label htmlFor="message" className="form-group leading-7 text-sm text-gray-600">Message</label>
          <textarea type="text"  id="message" name="user_subject" className="form-control w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
        </div>
