...
console.log(prodInfo) 
  return (
    <div><section className="text-gray-600 body-font overflow-hidden min-h-screen">
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <div className="flex items-center">
                <div className="relative">
                  <button className="ml-auto text-white bg-indigo-500 border-0 mx- py-2 px-2  md:px-9 focus:outline-none hover:bg-indigo-600 rounded">Track Shipment</button>
